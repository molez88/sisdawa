<button class="btn btn-success" onclick="add()"><i class="glyphicon glyphicon-plus"></i> Tambah Pendidikan</button>
...
$(document).ready(function() {
    ...
    table = $('#datatable-responsive').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('master/pendidikan/list_pendidikan')?>",
            "type": "POST"
        },
